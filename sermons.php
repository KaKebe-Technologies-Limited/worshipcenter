...
padding-bottom: 60px;
  ...
  <body>
    ...
    <section id="home" class="video-hero js-fullheight" style="height: 700px; background-image: url(images/sermon.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;" data-section="home">
						...
						<div class="row">
							<div class="col-md-12 d-md-flex">
								<div class="one-forth ftco-animate">
									...
									<p>"for we walk by faith not by sight" <br> <i>2 Corinthians 5:7</i></p>
								</div>
								<div class="one-half d-md-flex align-items-md-center ftco-animate">
									
									 <div class="countdown-wrap">
									 <h5 class="thoughts">"Always, everywhere God is present, and always He seeks to discover Himself to each one" - A.W.Tozer </h5>
									</div> 
									<div class="button">
	...
	<div class="panel panel-default">
	  ...
	  <!-- <div class="accordion-item">
		...
		<div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
		  <div class="accordion-body">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum provident quaerat soluta corrupti commodi odit numquam! Alias eveniet non sed.</div>
		</div>
	  </div>
	  <div class="accordion-item">
      ...
      <div class="container">
        <div class="row">
        	<div class="col-md-4 ftco-animate">
        		<div class="sermons">
        			<a href="https://youtu.be/f7lYwAmadEc" class="img popup-vimeo mb-3 d-flex justify-content-center align-items-center" style="background-image: url(images/sermons-2.jpg);">
        				<div class="icon d-flex justify-content-center align-items-center">
        					<span class="icon-play" href="https://youtu.be/f7lYwAmadEc"></span>
        				</div>
        			</a>
        			<div class="text">
        				<h3><a href="https://youtu.be/f7lYwAmadEc" target="blank">Favour</a></h3>
        				<span class="position">Pastor. Peter Okodo</span>
        				<p>Favour is an act of kindness beyond what is due or usual.</p>
        			</div>
        		</div>
        	</div>
        	<div class="col-md-4 ftco-animate">
        		<div class="sermons">
        			...
        			<div class="text">
        				<h3><a href="https://youtu.be/f7lYwAmadEc" target="blank">Favour</a></h3>
        				<span class="position">Pastor. Mario</span>
        				<p>Favour is an act of kindness beyond what is due or usual.</p>
        			</div>
        		</div>
        	</div>
        	...
        	<div class="col-md-4 ftco-animate">
        		<div class="sermons">
        			...
        			<div class="text">
						<h3><a href="https://youtu.be/f7lYwAmadEc" target="blank">Favour</a></h3>
        				<span class="position">Jacob</span>
        				<p>Favour is an act of kindness beyond what is due or usual.</p>
        			</div>
        		</div>
        	</div>
        	<div class="col-md-4 ftco-animate">
        		<div class="sermons">
        			...
        			<div class="text">
						<h3><a href="https://youtu.be/f7lYwAmadEc" target="blank">Favour</a></h3>
        				<span class="position">Sedrick Otolo</span>
        				<p>Favour is an act of kindness beyond what is due or usual.</p>
        			</div>
        		</div>
        	</div>
