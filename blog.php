...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="images/favicon.ico" type="png/jpeg/ico" style="color: white;">
    ...
    <section id="home" class="video-hero js-fullheight" style="height: 700px; background-image: url(images/bg_1.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;" data-section="home">
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-10 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs mb-2" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.php">Home</a></span> <span>Blog</span></p>
			...
			<div class="container-wrap">
				<div class="col-md-12 wrap">
                  ...
                  <h3>Scripture of the Day</h3>
                    ...
                    <h5 class="thoughts"> "Relying on God has to start all over everyday, as if nothing has yet been done."  –C. S. Lewis </h5>
        ...
        <div class="row">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry" data-aos-delay="100">
              <a href="#.php" class="block-20" style="background-image: url('images/image_4.jpg');">
              </a>
              <div class="text p-4">
                <div class="meta mb-3">
                  <div><a href="#">July 12, 2020</a></div>
