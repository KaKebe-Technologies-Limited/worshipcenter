  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="logo-div">
	      ...
	      <a class="navbar-brand" href="index.hphp><i class="flaticon-cross"></i> <span> Worship</span> <span>Center</span></a>
...
<div class="container">
  <center><h1 style="margin-top:60px;margin-bottom:40px;">Frequently asked questions</h1></center>
  <div class="accordion accordion-flush" id="accordionFlushExample">
    <div class="accordion-item">
      ...
      <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
        <div class="accordion-body">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Unde consequatur saepe minima aperiam facere quod incidunt odio repellat eum suscipit.</div>
      </div>
    </div>
    <div class="accordion-item">
