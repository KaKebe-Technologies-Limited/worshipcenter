  ...
  <body>
    ...
    <section id="home" class="video-hero js-fullheight" style="height: 700px; background-image: url(images/events/marriage.png);  background-size:cover; background-position: center center;background-attachment:fixed;" data-section="home">
						...
						<div class="row">
							<div class="col-md-12 d-md-flex">
								<div class="one-forth ftco-animate">
									<h3>Church Events</h3>
									<p>Stay Tuned for our Amazing events that impacts you</p>
								</div>
		...
		<section class="ftco-section" id="ftco-section-event" >
			<div class="container">
			  <div class="row justify-content-center mb-5 pb-5">
				<div class="col-md-6 text-center heading-section ftco-animate">
				  <span class="subheading">Church Events</span>
				  <h2 class="mb-4">Upcoming Events</h2>
				  <p>Bringing to you our monthly specials that keeps you strengthen in faith</i></p>
				</div>
			  </div>
			  <div class="row">
				<!-- event card  -->
				<div class="event-upcoming">
					<div class="image-event">
						<img src="images/events/marriage.png" height="auto" width="100%" alt="">
					</div>
		  ...
		  <section class="ftco-section">
			<div class="container">
			  <div class="row justify-content-center mb-5 pb-5">
				<div class="col-md-6 text-center heading-section ftco-animate">
				  <span class="subheading">Our Monthly Specials</span>
			  ...
			  <div class="row">
				<div class="col-md-6 col-lg-3 d-flex cont align-self-stretch ftco-animate">
				  <div class="media block-6 services d-block text-center">
					<div class="d-flex justify-content-center"><div class="icon d-flex icon_s justify-content-center mb-3"><span class="align-self-center flaticon-event"></span></div></div>
					<div class="media-body p-2 mt-3">
					  <h3 class="heading">Holy Communion service</h3>
				...
				<div class="col-md-6 col-lg-3 d-flex cont  align-self-stretch ftco-animate">
				  <div class="media block-6 services d-block text-center">
					...
					<div class="media-body p-2 mt-3">
					  <h3 class="heading">Overnight prayer</h3>
								<!-- <p> Serving God together is our joy</p> -->
					</div>
				  </div>      
				</div>
				...
				<div class="col-md-6 col-lg-3 d-flex cont align-self-stretch ftco-animate">
				  <div class="media block-6 services d-block text-center">
					<div class="d-flex justify-content-center"><div class="icon d-flex icon_s justify-content-center mb-3"><span class="align-self-center flaticon-worship"></span></div></div>
					<div class="media-body p-2 mt-3">
					  <h3 class="heading">Zoning Fellowship</h3>
								<!-- <p> Serving God together is our joy</p> -->
					</div>
				  </div>      
				</div>
			  ...
			  <div class="row cont">
				<div class="col-md-6 col-lg-3 d-flex cont align-self-stretch ftco-animate">
				  <div class="media block-6 services d-block text-center">
					<div class="d-flex justify-content-center"><div class="icon d-flex icon_s justify-content-center mb-3"><span class="align-self-center flaticon-worship"></span></div></div>
					<div class="media-body p-2 mt-3">
					  <h3 class="heading">Family care visits</h3>
								<!-- <p> Serving God together is our joy</p> -->
					</div>
				  </div>      
				</div>
				<div class="col-md-6 col-lg-3 d-flexcont  align-self-stretch ftco-animate">
				  <div class="media block-6 services d-block text-center">
					<div class="d-flex justify-content-center"><div class="icon d-flex icon_s justify-content-center mb-3"><span class="align-self-center flaticon-worship"></span></div></div>
					<div class="media-body p-2 mt-3">
					  <h3 class="heading">Standout Event </h3>
								<!-- <p> Serving God together is our joy</p> -->
					</div>
				  </div>      
				</div>
		...
		<section class="ftco-section ftco-section-2">
			<div class="container">
				<!-- <center><h1>Our Amazing Monthly specials</h1></center> -->
				<br>
				<hr>
				<div class="row">
					<div class="col-md-6">
