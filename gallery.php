...
<html lang="en">
  <head>
    <title>Worship Center | Gallery </title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <section id="home" class="video-hero js-fullheight" style="height: 700px; background-image: url(images/47.jpg);  background-size:cover; background-position: center center;background-attachment:fixed;" data-section="home">
		...
		<!-- <section class="ftco-bible-study">
			<div class="container-wrap">
				<div class="col-md-12 wrap">
                    ...
                    <p class="thoughts">What three words would you use to describe Jesus? </p>
									</div>
									<div class="button">
	...
	<div class="container">
		<div class="row">
			<div class="gallery-filter">
				...
				<span class="filter-item" data-filter="church">Church</span>
				<span class="filter-item" data-filter="sermons">Sermons</span>
				<span class="filter-item" data-filter="choir">Choir</span>
			</div>
		</div>
		<div class="row">
			<!-- gallery item start -->
			<div class="gallery-item church">
				<div class="gallery-item-inner">
					<img src="images/7.jpeg" alt="church">
				</div>
			</div>
			<!-- gallery item end -->
			<!-- gallery item start -->
			<div class="gallery-item sermons">
				<div class="gallery-item-inner">
					<img src="images/1.jpeg" alt="sermons">
				</div>
			</div>
			<!-- gallery item end -->
			<!-- gallery item start -->
			<div class="gallery-item choir">
				<div class="gallery-item-inner">
					<img src="images/2.jpeg" alt="choir">
				</div>
			</div>
			<!-- gallery item end -->
			<!-- gallery item start -->
			<div class="gallery-item church">
				<div class="gallery-item-inner">
					<img src="images/3.jpeg" alt="church">
				</div>
			</div>
			<!-- gallery item end -->
			<!-- gallery item start -->
			<div class="gallery-item sermons">
				<div class="gallery-item-inner">
					<img src="images/4.jpeg" alt="sermons">
				</div>
			</div>
			<!-- gallery item end -->
			<!-- gallery item start -->
			<div class="gallery-item choir">
				<div class="gallery-item-inner">
					<img src="images/5.jpeg" alt="choir">
				</div>
			</div>
			<!-- gallery item end -->
			...
			<div class="gallery-item church">
				<div class="gallery-item-inner">
					<img src="images/14.jpeg" alt="choir">
				</div>
			</div>
			<!-- gallery item end -->
      			<!-- gallery item start -->
			<div class="gallery-item sermons">
				<div class="gallery-item-inner">
					<img src="images/7.jpeg" alt="choir">
				</div>
			</div>
			<!-- gallery item end -->
      			<!-- gallery item start -->
			<div class="gallery-item choir">
				<div class="gallery-item-inner">
					<img src="images/8.jpeg" alt="choir">
				</div>
			</div>
			<!-- gallery item end -->
      			<!-- gallery item start -->
			<div class="gallery-item church">
				<div class="gallery-item-inner">
					<img src="images/9.jpeg" alt="choir">
				</div>
			</div>
			<!-- gallery item end -->
      			<!-- gallery item start -->
			<div class="gallery-item sermons">
				<div class="gallery-item-inner">
					<img src="images/10.jpeg" alt="choir">
				</div>
			</div>
			<!-- gallery item end -->
      			<!-- gallery item start -->
			<div class="gallery-item choir">
				<div class="gallery-item-inner">
					<img src="images/17.jpeg" alt="choir">
				</div>
			</div>
			<!-- gallery item end -->
      			<!-- gallery item start -->
			<div class="gallery-item church">
				<div class="gallery-item-inner">
					<img src="images/12.jpeg" alt="choir">
				</div>
			</div>
			<!-- gallery item end -->
      			<!-- gallery item start -->
			<div class="gallery-item sermons">
				<div class="gallery-item-inner">
					<img src="images/45.jpg" alt="choir">
				</div>
			</div>
			<!-- gallery item end -->
          			<!-- gallery item start -->
